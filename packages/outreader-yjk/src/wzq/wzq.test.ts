...
import { wzq as wzq1 } from '../../../../fixtures/test-result/yjk-1/wzq';
import { wzq as wzq2 } from '../../../../fixtures/test-result/yjk-2/wzq';
...
describe('wzq1', () => {
  ...
  it('should extract modeSeismic', async () => {
    ...
    expect(modeSeismic.modeID[3]).toBe(wzq1.modeID);
    expect(modeSeismic.period[3]).toBe(wzq1.modeSeismicPeriod);
    expect(modeSeismic.factorX[3]).toBe(wzq1.modeSeismicFactorX);
  });
...
describe('wzq2', () => {
  ...
  it('should extract modeSeismic', async () => {
    const modeSeismic = wzq.modeSeismic;
    expect(modeSeismic.modeID[3]).toBe(wzq2.modeID);
    expect(modeSeismic.period[3]).toBe(wzq2.modeSeismicPeriod);
    expect(modeSeismic.factorX[3]).toBe(wzq2.modeSeismicFactorX);
  });
